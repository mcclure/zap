...
pub const SPRITE_SIZE:usize = mem::size_of::<f32>()*8;
pub const SPRITES_MAX:u32 = 512; // 13*13*2 = 338, round up for room for bullets. (Realistically, 256 would be enough)
